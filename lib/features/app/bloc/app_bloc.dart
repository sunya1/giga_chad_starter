...
sealed class AppState with _$AppState {
  ...
  const factory AppState.idle({Locale? locale, AppThemeScheme? appTheme}) = _IdleAppState;
  const factory AppState.processing({Locale? locale, AppThemeScheme? appTheme}) = _ProcessingAppState;
  const factory AppState.error({required Object cause, Locale? locale, AppThemeScheme? appTheme}) = _ErrorAppState;
}
...
sealed class AppEvent with _$AppEvent {
  ...
  const factory AppEvent.updateTheme({required AppThemeScheme appTheme}) = _UpdateThemeAppEvent;
