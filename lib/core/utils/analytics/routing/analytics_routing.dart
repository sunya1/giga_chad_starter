...
import 'package:giga_chad_starter/core/utils/analytics/routing/analytics_route_config.dart';
import 'package:giga_chad_starter/core/utils/analytics/routing/analytics_route_default_config.dart';
...
mixin RouteAwareAnalytics<T extends StatefulWidget> on State<T>
  ...
  void didPopNext() {
    ...
    if (analyticsRoute != null) {
      AnalyticsRouteObserver.config
          .onRouteChanged(analyticsRoute!);
    }
  }
