...
import 'package:giga_chad_starter/core/utils/analytics/analytics_config.dart';
import 'package:giga_chad_starter/core/utils/analytics/analytics_event.dart';
import 'package:giga_chad_starter/core/utils/analytics/analytics_interceptor.dart';
import 'package:giga_chad_starter/core/utils/analytics/analytics_property.dart';
import 'package:giga_chad_starter/core/utils/analytics/events/screen_view_event.dart';
  ...
  Future<void> reportEvent(AnalyticsEvent event) async {
    ...
    for (final interceptor in _interceptors) {
      await interceptor.afterReport(
        event.name,
        builder.properties
            .map((it) => MapEntry(it.name, it.value.toString()))
            .let(Map.fromEntries),
      );
    }
  }
